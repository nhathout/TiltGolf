...
QT_MOC_LITERAL(3, 26, 7) // "levelId"

    },
    "MenuScreen\0levelSelected\0\0levelId"
};
...
void MenuScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->levelSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MenuScreen::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuScreen::levelSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MenuScreen::levelSelected(int _t1)
{
